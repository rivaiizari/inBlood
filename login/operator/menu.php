...
<nav class="navbar-inverse navbar-fixed-top" role="navigation">
	...
	<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
		<ul class="nav navbar-nav">
			<li>
			<a class="navbar-brand">Halaman Profil Anggota instansi in Blood </a>
			<a style="margin-left: 40px; font-size: 17px; font-weight: bold; color: #DDDDDD"  class="nav navbar-brand navbar-nav navbar-center"> Hellow,<?= $_SESSION['username']; ?></a>
			</li>
		</ul>
